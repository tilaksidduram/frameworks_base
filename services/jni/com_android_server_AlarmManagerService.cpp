...
static jint android_server_AlarmManagerService_setKernelTimezone(JNIEnv* env, jobject, jint, jint minswest)
{
    struct timezone tz;
...
static jint android_server_AlarmManagerService_init(JNIEnv* env, jobject)
{
    return open("/dev/alarm", O_RDWR);
}

static void android_server_AlarmManagerService_close(JNIEnv* env, jobject, jint fd)
{
    close(fd);
}

static void android_server_AlarmManagerService_set(JNIEnv* env, jobject, jint fd, jint type, jlong seconds, jlong nanoseconds)
{
    struct timespec ts;
    ts.tv_sec = seconds;
